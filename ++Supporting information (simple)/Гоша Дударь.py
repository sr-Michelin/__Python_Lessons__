"""
# Все ради KSP та ##### (або себе -- 20/06/21)
...
"------------------while not ---if---------else--------------------"
# Використання циклів у задачці, яка зрівнює один з одним два введені чила
print ("")
...
while not  num_1==num_2:
    if num_1>num_2:
        ...
        print("A=B")
"----------------while not----------------------------------"
# Виведення числа до шуканого черз цикл
Num_1=int(input("Введіть будь-яке число:"))
while not Num_1==1000:
    Num_1+=1
    print(Num_1)
"------------Test---------------------------------------"
# Прога для перемноження введеного знаку на введене число
...
print(A)
"-----------------for------------------------------------"
# Запис "Hello World" з подвоєнням кожної літери
...
l=[1,4,7]
print(l[:2])      # третій елемент (у Python нумерація починається з нуля, а не з одиниці)
...
print(D2)
#або [] кортеж:
D3=dict([('key_1',input('key_1: ')),('key_2',input('key_2: '))])
print(D3)
#або fromkeys - створення значень ключів  - для усіх значень a і b присвоюється:
D5=dict.fromkeys(['a','b','c','d','e','g'],input('Введіть нове значення для усіх нових ключів: '))
print(D5)
#або- через цикл:
...
student ={'name':{'last name':'Шевченко', 'first name':'Михайло','middle name':'Сергійович'},'adress':['
**************'],'tell':{'t_first':'***********','t_second':"3-98-11"}}
